...
const pillars: Pillar[] = [
  ...
  },
  {
    ...
    number: "02",
    title: "People",
    description: "Spotlight the artisans, creators, and communities who make Assam what it is.",
  ...
  },
  {
    ...
    number: "03",
    title: "Opportunities",
    description: "Open doors to education, skills, jobs, and entrepreneurship for the next generation.",
  ...
  },
  {
    ...
    number: "04",
    title: "Future",
    description: "Build a platform that grows with Assam — and, one day, all of Northeast India.",
 ...
 * connected by an organic silk thread, with the active pillar driven
 * by either hover or scroll position, and a very subtle background
 * color response to whichever pillar is active.
 */
